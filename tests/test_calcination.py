...
from cards.objects import Calcination
...
def test_3_ressources_pour_1_pearl(setup):
    """Paie 3 ressources et reçoit 1 PEARL"""
    ...
    assert player.resources.resources[Resource.PEARL] == 1
